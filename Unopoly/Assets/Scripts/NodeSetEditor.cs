...
{
    SerializedProperty nodeSetListPtoperty;

    void OnEnable()
    {
        nodeSetListPtoperty = serializedObject.FindProperty("nodeSetList");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(nodeSetListPtoperty, true);
